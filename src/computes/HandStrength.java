...
public class HandStrength {
	...
	public static double countHandStrenght(Integer[] deck, Integer[] myCards, ArrayList<Integer> cards){
		int all = 0;
		double hs = 0;
	...
	private static double countHS(Integer[] deck, Integer[] myCards, ArrayList<Integer> cards){
		int all = 0, good = 0;
		int opRank;
